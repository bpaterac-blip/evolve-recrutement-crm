...
export const MATURITIES = ['Chaud', 'Tiède', 'Froid', 'Chute', 'En pause', 'Pas intéressé', 'Archivé']
export const PAUSE_REASONS = ['Vie personnelle', 'Projet immobilier', 'Congé parental', 'Pas le bon moment', 'Attente interne', 'Autre']
...
export const PAS_INTERESSE_TYPES = ['Pas intéressé par l\'indépendance', 'Trop tôt dans sa carrière', 'Satisfait de sa situation actuelle', 'Ne souhaite pas être recontacté', 'Sans réponse après relances', 'Autre']
