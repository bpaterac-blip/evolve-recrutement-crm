...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    tasks: [
      { id: ‘t5_1’, label: ‘Remplir le formulaire CNCEF’, links: [‘cncef’] },
      { id: ‘t5_2’, label: ‘Envoyer le mail au CGP’, links: [‘mail_cncef’] },
      { id: ‘t5_3’, label: ‘Attendre l\’attestation CNCEF → l\’intégrer au dossier Drive du CGP’, links: [‘dossier’] },
    ],
  },
  {
    id: 6,
    ...
    tasks: [
      { id: ‘t6_1’, label: ‘Remplir le formulaire CNPM (affiliation : ADHÉRENT CNCEF — PAIEMENT ANNUEL)’, links: [‘cnpm’] },
      { id: ‘t6_2’, label: ‘Créer identifiant avec mail du gérant + mot de passe #NomAnnée (ex: #Garcia2025)’, links: [] },
      { id: ‘t6_3’, label: ‘Envoyer mail au gérant avec ses identifiants CNPM’, links: [] },
      { id: ‘t6_4’, label: ‘Attendre attestation CNPM → l\’intégrer au dossier Drive’, links: [‘dossier’] },
    ],
  },
  {
    id: 7,
