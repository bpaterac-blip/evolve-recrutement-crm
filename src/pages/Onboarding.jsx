    ...
    mailTemplates: [
      {
        ...
        body: `<p>Bonjour Alexia,</p><p>Peux-tu bien vouloir procéder à l'enregistrement du nouvel adhérent au Groupement EVOLVE COURTAGE s'il te plait :</p><p><strong>Coordonnées</strong></p><p>{{prenom}} {{nom}}</p><p>{{societe}}</p><p>SIREN : {{siren}}</p><p>{{email}}</p><p>{{telephone}}</p><p><strong>Tu trouveras en PJ :</strong></p><ul><li>Convention liant l'adhérent au groupement</li><li>RIB PRO</li><li>KBIS de moins de trois mois de l'Adhérent</li><li>Orias de l'année en cours</li><li>CNI de l'adhérent</li><li>CV de l'adhérent</li><li>AP COM signé</li><li>Demande de partenariat signée</li></ul><p>Te souhaitant bonne réception,</p><p>Bien à toi,</p><p>{{responsable}}</p>`,
      },
      {
        label: 'SwissLife',
