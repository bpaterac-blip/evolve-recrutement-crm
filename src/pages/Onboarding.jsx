...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    tasks: [
      { id: 't6_1', label: 'Remplir le formulaire CNCEF', links: ['cncef'] },
      { id: 't6_2', label: 'Envoyer le mail au CGP', links: ['mail_cncef'] },
      { id: 't6_3', label: 'Attendre l\'attestation CNCEF → l\'intégrer au dossier Drive du CGP', links: ['dossier'] },
    ],
  },
  {
    id: 7,
    short: 'ORIAS',
    name: 'Immatriculation ORIAS',
    optional: false,
    yousign: false,
    waitAttestation: true,
    mailTemplate: {
    ...
    tasks: [
      { id: 't7_1', label: 'Remplir formulaire ORIAS', links: ['orias'] },
      { id: 't7_2', label: 'Envoyer mail ORIAS au CGP', links: [] },
      { id: 't7_3', label: 'Attendre attestation ORIAS → l\'intégrer au dossier Drive', links: ['dossier'] },
    ],
  },
  {
    id: 8,
    ...
    tasks: [
      { id: 't8_1', label: 'Modifier la convention de partenariat (attention : modèle SAS, pas SARL)', links: ['convention_sas', 'convention_sarl'] },
      { id: 't8_2', label: 'Envoyer via YouSign (formulaire → 3 petits points → remplir le formulaire)', links: [] },
      { id: 't8_3', label: 'Envoyer mail de confirmation au gérant', links: [] },
    ],
  },
  {
    id: 9,
    ...
    mailTemplates: [
      {
        ...
        body: `<p>Bonjour Alexia,</p><p>Peux-tu bien vouloir procéder à l'enregistrement du nouvel adhérent au Groupement EVOLVE COURTAGE s'il te plait :</p><p><strong>Coordonnées</strong></p><p>NOM CABINET DE L'ADHERENT</p><p>ADRESSE POSTALE ADHERENT</p><p>ADRESSE MAIL ADHERENT</p><p>TELEPHONE ADHERENT</p><p><strong>Tu trouveras en PJ :</strong></p><ul><li>Convention liant l'adhérent au groupement</li><li>RIB PRO</li><li>KBIS de moins de trois mois de l'Adhérent</li><li>Orias de l'année en cours</li><li>CNI de l'adhérent</li><li>CV de l'adhérent</li><li>AP COM signé</li><li>Demande de partenariat signée</li></ul><p>Te souhaitant bonne réception,</p><p>Bien à toi,</p><p>{{responsable}}</p>`,
      },
      {
        label: 'SwissLife',
